...
public class AttributeRadiationCrafter extends RadiationCrafter{
    ...
    public AttributeRadiationCrafter(String name){
        super(name);
    }
    ...
    public class AttributeCrafterBuild extends RadiationCrafterBuild{
